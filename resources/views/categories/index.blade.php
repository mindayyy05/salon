            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-6 bg-gradient-to-r from-blue-100 to-blue-50 border-b border-gray-200 rounded-t-lg">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-3xl font-bold text-blue-700">Category Management</h3>
                        <a href="{{ route('categories.create') }}" class="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 ease-in-out shadow-md hover:shadow-lg">
                            Create New Category
                        </a>
                    </div>
                        ...
                        <tbody class="text-gray-700">
                            @foreach ($categories as $category)
                                <tr class="@if($loop->even) bg-gray-50 @endif hover:bg-gray-100 transition duration-150 ease-in-out">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $category->description }}</td>
                                    <td class="border border-gray-300 px-6 py-4 space-x-2 flex">
                                        <a href="{{ route('categories.show', $category->id) }}" class="bg-gradient-to-r from-gray-400 to-gray-500 hover:from-gray-500 hover:to-gray-600 text-white py-1 px-4 rounded-lg transition duration-200 shadow-md hover:shadow-lg">
                                            View
                                        </a>
                                        <a href="{{ route('categories.edit', $category->id) }}" class="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-white py-1 px-4 rounded-lg transition duration-200 shadow-md hover:shadow-lg">
                                            Edit
                                        </a>
                                        <button onclick="openDeleteModal({{ $category->id }})" class="bg-gradient-to-r from-red-400 to-red-500 hover:from-red-500 hover:to-red-600 text-white py-1 px-4 rounded-lg transition duration-200 shadow-md hover:shadow-lg">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
