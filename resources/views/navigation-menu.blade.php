            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('admin')
                        ...
                        <x-nav-link href="{{ route('stylists.index') }}" :active="request()->routeIs('stylists.index')">
                            {{ __('Stylists') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('admin')
                ...
                <x-responsive-nav-link href="{{ route('stylists.index') }}" :active="request()->routeIs('stylists.index')">
                    {{ __('Stylists') }}
                </x-responsive-nav-link>
